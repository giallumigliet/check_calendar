...
onAuthStateChanged(auth, user => {
  if(user){
    ...
    onSnapshot(tasksRef, snapshot => {
      ...
      createTaskList(taskList, tasks, currentTask, calendarDays, calendarTitle, date, progressBar, progressText, calendarWrapper, buttonFooter, panel, overlay, taskForm, taskManager, hueContainer, editTaskBtn, saveTaskBtn, taskHueInput, taskNameInput);
...
listenTaskButtons(taskBtn, closePanel, panel, overlay, calendarWrapper, buttonFooter, taskManager, taskForm, taskList, taskNameInput, taskHueInput, huePreview);
